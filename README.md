...
```bash
omarchy-theme-install https://github.com/stulzer/omarchy-stz-theme.git
```

Or via the Omarchy menu:

- Open Omarchy Menu (`Super + Alt + Space`)
- Go to **Install > Style > Theme** and paste https://github.com/stulzer/omarchy-stz-theme.git
